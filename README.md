...
build_index.py is to be run once on your machine which converts the information PDFs from the documents folder into chunks, currently numbering 443, and store them in a FAISS vector index
